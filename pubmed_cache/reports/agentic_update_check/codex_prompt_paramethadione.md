...
Row bundle JSON:
{
  ...
  "csv_row": {
    ...
    "fda_black_box_warning_source": "FDA/DailyMed search on 05-20-2026: no current label found for terms [paramethadione; Paradione].",
    ...
    "filter_formulation": "Capsule; Historical/not marketed; Liquid",
    ...
    "formulations_available": "Historical oral capsule; historical oral solution (not marketed in U.S.)",
    "generic_name": "paramethadione",
    ...
    "pubmed_search_aliases": "Paradione",
    ...
    "status_or_notes": "FDA Orange Book pre-1982 legacy ASM product (Paradione); discontinued U.S. product listing.",
    "trade_names": "Paradione",
  ...
  "latest_deterministic_update_check_findings_for_row": [
    {
      ...
      "current_value": "FDA/DailyMed search on 05-19-2026: no current label found for terms [paramethadione; Paradione].",
      "details": {},
      "evidence_url": "https://open.fda.gov/apis/drug/label/",
      "generic_name": "paramethadione",
      "id": "fda_warning_metadata_refresh-6bf8fa9e6427",
      ...
      "proposed_updates": {
        ...
        "fda_black_box_warning_source": "FDA/openFDA label API search on 05-19-2026: no current FDA label found for terms [paramethadione; Paradione].",
        "fda_black_box_warning_verified": "05-19-2026"
      },
      "proposed_value": "FDA/openFDA label API search on 05-19-2026: no current FDA label found for terms [paramethadione; Paradione].",
