...
Row bundle JSON:
{
  ...
  "csv_row": {
    ...
    "fda_black_box_warning_source": "FDA/DailyMed search on 05-20-2026: no current label found for terms [metharbital; Gemonil].",
    ...
    "status_or_notes": "FDA Orange Book pre-1982 legacy ASM product (Gemonil); discontinued U.S. product listing.",
    "trade_names": "Gemonil",
  ...
  "latest_deterministic_update_check_findings_for_row": [
    {
      ...
      "current_value": "FDA/DailyMed search on 05-19-2026: no current label found for terms [metharbital; Gemonil].",
      "details": {},
      "evidence_url": "https://open.fda.gov/apis/drug/label/",
      "generic_name": "metharbital",
      "id": "fda_warning_metadata_refresh-778d14e046fd",
      ...
      "proposed_updates": {
        ...
        "fda_black_box_warning_source": "FDA/openFDA label API search on 05-19-2026: no current FDA label found for terms [metharbital; Gemonil].",
        "fda_black_box_warning_verified": "05-19-2026"
      },
      "proposed_value": "FDA/openFDA label API search on 05-19-2026: no current FDA label found for terms [metharbital; Gemonil].",
