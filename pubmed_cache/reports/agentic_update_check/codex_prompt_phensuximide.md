...
Row bundle JSON:
{
  ...
  "csv_row": {
    ...
    "fda_black_box_warning_source": "FDA/DailyMed search on 05-20-2026: no current label found for terms [phensuximide; Milontin].",
    ...
    "filter_formulation": "Capsule; Historical/not marketed",
    ...
    "formulations_available": "Historical oral capsule (not marketed in U.S.)",
    "generic_name": "phensuximide",
    ...
    "pubmed_search_aliases": "Milontin",
    ...
    "status_or_notes": "FDA Orange Book pre-1982 legacy ASM product (Milontin); discontinued U.S. product listing.",
    "trade_names": "Milontin",
  ...
  "latest_deterministic_update_check_findings_for_row": [
    {
      ...
      "current_value": "FDA/DailyMed search on 05-19-2026: no current label found for terms [phensuximide; Milontin].",
      "details": {},
      "evidence_url": "https://open.fda.gov/apis/drug/label/",
      "generic_name": "phensuximide",
      "id": "fda_warning_metadata_refresh-dd89eda17606",
      ...
      "proposed_updates": {
        ...
        "fda_black_box_warning_source": "FDA/openFDA label API search on 05-19-2026: no current FDA label found for terms [phensuximide; Milontin].",
        "fda_black_box_warning_verified": "05-19-2026"
      },
      "proposed_value": "FDA/openFDA label API search on 05-19-2026: no current FDA label found for terms [phensuximide; Milontin].",
