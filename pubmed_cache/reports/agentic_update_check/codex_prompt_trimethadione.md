...
Row bundle JSON:
{
  ...
  "csv_row": {
    ...
    "fda_black_box_warning_source": "FDA/DailyMed search on 05-20-2026: no current label found for terms [trimethadione; Tridione].",
    ...
    "filter_formulation": "Capsule; Historical/not marketed; Liquid; Tablet",
    ...
    "formulations_available": "Historical oral capsule; historical oral solution; historical oral tablet (not marketed in U.S.)",
    "generic_name": "trimethadione",
    ...
    "pubmed_search_aliases": "Tridione",
    ...
    "status_or_notes": "FDA Orange Book pre-1982 legacy ASM product (Tridione); discontinued U.S. product listing.",
    "trade_names": "Tridione",
  ...
  "latest_deterministic_update_check_findings_for_row": [
    {
      ...
      "current_value": "FDA/DailyMed search on 05-19-2026: no current label found for terms [trimethadione; Tridione].",
      "details": {},
      "evidence_url": "https://open.fda.gov/apis/drug/label/",
      "generic_name": "trimethadione",
      "id": "fda_warning_metadata_refresh-ae7a49794db6",
      ...
      "proposed_updates": {
        ...
        "fda_black_box_warning_source": "FDA/openFDA label API search on 05-19-2026: no current FDA label found for terms [trimethadione; Tridione].",
        "fda_black_box_warning_verified": "05-19-2026"
      },
      "proposed_value": "FDA/openFDA label API search on 05-19-2026: no current FDA label found for terms [trimethadione; Tridione].",
